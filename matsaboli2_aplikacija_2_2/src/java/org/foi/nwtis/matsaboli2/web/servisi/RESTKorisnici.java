...
/**
 * Jersey REST client generated for REST resource:RestKorisniciResourceContainer
 * [/RESTKorisnici]<br>
 * USAGE:
 * <pre>
 *        RESTKorisnici client = new RESTKorisnici();
...
public class RESTKorisnici {
    ...
    public RESTKorisnici() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("RESTKorisnici");
    }
